...
app.post("/api/gemini/scan-footprint", async (req, res) => {
  try {
    ...
    Estimate its carbon footprint during active usage.
    ...
    Return your response in JSON format matching this TypeScript structure:
    {
      "item": "Name of the detected product/item",
      "category": "One of: 'energy', 'food', 'transport', 'waste'",
      "usageFootprint": "Estimated carbon footprint in active usage",
      "lifecycleFootprint": "Estimated manufacturing/logistics lifecycle footprint",
      "equivalentAction": "A fun and relatable daily action equivalent",
      "ecoRating": "An ecological grade from A to F",
      "tips": ["Tip 1", "Tip 2", "Tip 3"],
      "alternatives": ["Alternative 1", "Alternative 2"],
      "potentialSavings": 5,
      "pointsReward": 50
    }
    Return the raw JSON string only.`;
